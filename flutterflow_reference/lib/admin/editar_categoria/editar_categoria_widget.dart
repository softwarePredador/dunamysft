...
class EditarCategoriaWidget extends StatefulWidget {
  ...
  final CategoryRecord? categoriaID;

  static String routeName = 'editar_categoria';
  static String routePath = '/editarCategoria';
...
class _EditarCategoriaWidgetState extends State<EditarCategoriaWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CategoryRecord>(
      stream: CategoryRecord.getDocument(widget.categoriaID!.reference),
      builder: (context, snapshot) {
        ...
        final editarCategoriaCategoryRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.textController ??=
                                  ...
                                  text: editarCategoriaCategoryRecord.name,
                                ),
                                ...
                                decoration: InputDecoration(
                                  isDense: true,
                                  labelText: 'Categoria',
                                  hintText: editarCategoriaCategoryRecord.name,
                        ...
                        onTap: () async {
                          var confirmDialogResponse = await showDialog<bool>(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: Text('Atualizar Categoria'),
                                    content:
                                        Text('Deseja atualizar essa categora?'),
                                    actions: [
                                      TextButton(
                          ...
                          if (confirmDialogResponse) {
                            await widget.categoriaID!.reference
                            ...
                            context
                                .pushNamed(CadastroCategoriaWidget.routeName);
                          }
                        },
                        child: Container(
                          width: 220.0,
                          ...
                          var confirmDialogResponse = await showDialog<bool>(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    ...
                                    content:
                                        Text('Deseja excluir essa categora?'),
                                    actions: [
                                      TextButton(
                                        onPressed: () => Navigator.pop(
                                            alertDialogContext, false),
