    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 115.0),
              child: Container(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: FlutterFlowChoiceChips(
                                options: [
                                  ChipData('😃 Gostei'),
                                  ChipData('😔 Atendimento ruim'),
                                  ChipData('🏓 Sala de jogos'),
                                  ChipData('🤑 Bom preço'),
                                  ChipData('🛌🏼 Bom para dormir'),
                                  ChipData('💦‍️ Piscina boa'),
                                  ChipData('🍔 Comida boa'),
                                  ChipData('💪🏽 Academia'),
                                  ChipData('🧹 Limpeza'),
                                  ChipData('🤝 Bom para reuniões'),
                                  ChipData('🔫 Perigoso')
                                ],
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: RatingBar.builder(
                              ...
                              itemCount: 5,
                              itemSize: 32.0,
                              glowColor: FlutterFlowTheme.of(context).amarelo,
                            ),
                          ),
                        ),
                        Padding(
                              ...
                              children: [
                                    ...
                                    onTap: () async {
                                      await FeedbackRecord.collection
                                        ...
                                        ...createFeedbackRecordData(
                                          ...
                                          emotion: _model.choiceChipsValue,
                                          ranking:
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 0.0, 50.0),
                                  child: Text(
                                    'Entre em nosso site e garanta a sua próxima estadia com os melhores preços!',
