            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Row(
                    children: [
                      const Icon(Icons.receipt, color: AppTheme.amarelo),
                      const SizedBox(width: 8),
                      Text('Pedido #${order.codigo}', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
                    ],
                  ),
              ...
              // Details
              _buildInfoRow(context, icon: Icons.calendar_today, label: 'Data', value: order.date != null ? dateFormat.format(order.date!) : 'N/A'),
              const SizedBox(height: 8),
              if (order.room.isNotEmpty) _buildInfoRow(context, icon: Icons.hotel, label: 'Quarto', value: order.room),
              ...
              const SizedBox(height: 8),
              if (order.payment.isNotEmpty) _buildInfoRow(context, icon: Icons.payment, label: 'Pagamento', value: order.payment),
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: Theme.of(context).textTheme.titleLarge?.copyWith(color: AppTheme.amarelo, fontWeight: FontWeight.bold),
                  ),
                ],
              ),
            ],
  ...
  Widget _buildInfoRow(BuildContext context, {required IconData icon, required String label, required String value}) {
    return Row(
      children: [
        ...
        const SizedBox(width: 8),
        Text('$label: ', style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: AppTheme.secondaryText)),
        Expanded(
